...
public:
     ...
     * @param Левая граница интервала (включительно)
     * @param Правая граница интервала (включительно)
     * @return Случайное число в заданном интервале
     */
    ushort getRandomFromInterval(ushort minimal, ushort maximal);

    /**
     * @brief Получить последовательность из символов, коды которых находятся в заданном промежутке
     * @param Левая граница символов (код, включительно)
     * @param Правая граница символов (код, включительно)
